$(document).ready(function() {
		...
		$("#form").validate({
	         ...
	         submitHandler : function(form){
		        $("#div-botao").hide();  
	           	//$("#div-load").show(); 
		       	document.form.action = "relatorioBonusPagamentoProporcionalidade.do?operacao=montaTelaPrincipal";   
		...
		$("#exportar").click(function() {   
		 ...
		 document.form.action = "relatorioBonusPagamentoProporcionalidade.do?operacao=exportaRelatorioExcel";   
		 document.form.submit();
