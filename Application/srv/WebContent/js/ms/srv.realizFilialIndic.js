$(document).ready(function() {
	...
	$("#form").validate({
        ...
        submitHandler : function(form){
    		$("#div-botao").hide();
           	$("#div-load").show();
           	document.form.action = "realizFilialIndic.do?operacao=executarFiltro";   
	...
	$("#botaoImportar").click(function() {
		modal(580,300,'paginas/realizFilialIndic/importaRealizFilialIndic.jsp','Marisa - Importar Realizado Filial',true,'',true);
	});
