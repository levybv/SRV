$(document).ready(function() {
		...
		$("#form").validate({
	         ...
	         submitHandler : function(form){
		        $("#div-botao").hide();  
	           	//$("#div-load").show(); 
		       	document.form.action = "relatorioBonusConferencia.do?operacao=montaTelaPrincipal";   
		...
		$("#exportar").click(function() {   
		 ...
		 document.form.action = "relatorioBonusConferencia.do?operacao=exportaRelatorioExcel";   
		 document.form.submit();
