$(document).ready(function() {
		...
		$("#form").validate({
	         ...
	         submitHandler : function(form){
		        $("#div-botao").hide();  
	           	//$("#div-load").show(); 
		       	document.form.action = "relatorioDesempenhoColaborador.do?operacao=montaTelaPrincipal";   
		...
		$("#exportar").click(function() {   
		 ...
		 document.form.action = "relatorioDesempenhoColaborador.do?operacao=exportaRelatorioExcel";   
		 document.form.submit();
