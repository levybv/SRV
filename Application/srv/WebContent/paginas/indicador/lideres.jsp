...
<fmt:setLocale value="pt_BR" scope="request"/>
	<display:table pagesize='15' id="lista" name="lista" class="table" requestURI="" decorator="">     
		...
		<display:column property="meta"               format="{0,number,#,##0.00}"  title="Meta" style="text-align: right; cursor: pointer; width: 5%; vertical-align: middle;"/>		
