	...
	$(document).ready(function() {
		...
		$("#detGrupoRemVar").validate({
	        ...
	        submitHandler : function(form){
		    	$("#div-botao").hide();  
	           	$("#div-load").show(); 
		       	document.detGrupoRemVar.action = "grupoRemVarBonus.do?operacao=processaBonus";   
	            document.detGrupoRemVar.submit();
	        }
    	});
    	
    	$("#grupoRemVarDIV").html(idGrupoRemVar + " - " + descricaoGrupoRemVar);
    	$("#idGrupoRemVarC").val(idGrupoRemVar);
...
<div id="corpoModalAlterarConfigFilial" style="float:left;margin-left: 10px; width: 770px;">
	<form name="detGrupoRemVar" id="detGrupoRemVar" method="post"> 
			
		<input type='hidden' id="idGrupoRemVarC"      	name="idGrupoRemVarC" 	    value="">
			...
			<tbody> 
				<tr>
					<td class="componente" width="20%">
						<label class="label">Grupo de Remuneração:<span class="requerido">*</span></label> 
					</td>
					<td class="componente" id="grupoRemVarDIV" >
					</td>
				</tr>
				<tr>
					<td class="componente" >
				...
				<tr>
					...
					<td class="componente" >
  						<input type="text" class="campo2" id="realizadoC" name="realizadoC" value="" maxlength="22" size="15" style="width:125px;" />
					</td>	
				</tr>					
			</tbody>
		</table>
