...
<script type="text/javascript" src="js/ms/srv.bonusFuncionario.js" charset="ISO-8859-1"></script>
...
<div id="box" class="box">
	<div class="boxCenter">
		<div class="barTitleInternoCadastro">Desempenho do Colaborador - Funcionários</div>
		<br/>
		<div class="panel">
			<form id="form" name="form" method="post" action="" accept-charset="ISO-8859-1">
				...
				<div id="botao-geral">
					<div id="botao" class="barBottom"> 
						<div id="div-botao">
							<input id="botaoProcessar" type="button" class="button" value="Processar" />
