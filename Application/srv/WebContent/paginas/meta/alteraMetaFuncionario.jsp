	...
	$(document).ready(function() {
			...
			function (unidades) {
				...
				MetaFuncionarioBusinessAjax.obtemMetaFuncionario(mes, ano, idFuncionario, idIndicador,
					function (metaFuncionarioVO) {
						...
						$("#idUnidadeMetaMF").val(metaFuncionarioVO.idUnidadeMeta);
						$("#valorMetaMF").val(metaFuncionarioVO.valorMetaFormatado);
						if (metaFuncionarioVO.descricaoMeta != null) {
							$("#descricaoMetaMF").val(metaFuncionarioVO.descricaoMeta);
						}
				}); 				
		});		
		...
		$("#detMeta").validate({
	         ...
	         submitHandler : function(form){
		        $("#div-botao").hide();  
	           	$("#div-load").show(); 
		       	document.detMeta.action = "metaFuncionario.do?operacao=alteraMetaFuncionario";   
			...
			<table class="tabelaComponente">
				<tbody> 
					...
					<tr>
						...
						<td class="componente" >
	  						<input type="text" class="campo2" id="descricaoMetaMF" name="descricaoMetaMF" value="" maxlength="100" size="70"  />
						</td>
					</tr>	
				</tbody>
			</table>
