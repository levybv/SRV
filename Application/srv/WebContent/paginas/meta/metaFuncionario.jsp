...
<script type="text/javascript" src="js/ms/srv.metaFuncionario.js" charset="ISO-8859-1"></script>
...
<div id="box" class="box">
	<div class="boxCenter">
		<div class="barTitleInternoCadastro">Metas por Funcionário</div>
		<br/>
		<div class="panel">
			<form id="form" name="form" method="post" action="" accept-charset="ISO-8859-1">
                ...
                <div class="painel-filtro">
                	<table class="tabelaComponente">
                    	<tbody>
                        	...
                        	<tr>
 	                        	<td class="componente">
 	                        		<label class="label" for="filialDesc">Cód. Funcionário:</label>
 	                        	</td>
 	                        	<td class="componente"> 	                        		
                                	<input id="idFuncionarioF" name="idFuncionarioF" value="<c:out value='${idFuncionarioF}'/>" class="campo2" maxlength="9" style="width: 100px;" type="text"/>
                                </td>
 	                        	<td class="componente">
 	                        		<label class="label" for="filialDesc">Nome:</label>
 	                        	</td>
 	                        	<td class="componente"  colspan="3"> 	                        		
                                	<input id="nomeFuncionarioF" name="nomeFuncionarioF" value="<c:out value='${nomeFuncionarioF}'/>" class="campo2" maxlength="100" style="width: 300px;" type="text"/>
                                </td>
                            </tr>                            
                        </tbody>
                    </table>
				...
				<display:table pagesize='10' id="metasFuncionarios" name="metasFuncionarios" class="table" requestURI="">     
					<display:setProperty name="paging.banner.placement" value="bottom" />   
					<display:column title="" style="width:5%; text-align:center; "><input type="radio" name="checkbox" id="checkbox" value="${metasFuncionarios.idIndicador};${metasFuncionarios.idFuncionario};${metasFuncionarios.ano};${metasFuncionarios.mes}"></display:column>
					...
					<display:column property="funcionarioFormatado" title="Funcionário" style="cursor: pointer; vertical-align: middle; width:25%;" /> 
					<display:column property="valorMetaFormatado" title="Valor Meta" style="width:10%; text-align:right; cursor: pointer; vertical-align: middle;"/>
					<display:column property="descricaoMeta"   title="Descrição"   style="cursor: pointer; vertical-align: middle; width:30%;" /> 
				</display:table>
				<BR>
			</form>
		</div>
