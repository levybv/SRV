...
<script type="text/javascript" src="js/ms/srv.salarioBase.js" charset="ISO-8859-1"></script>
...
<div id="box" class="box">
	<div class="boxCenter">
		<div class="barTitleInternoCadastro">Salário Base</div>
		<br/>
		<div class="panel">
			...
			<input type='hidden' id="idFilialFunc" name="idFilialFunc" value="<c:out value='${funcionario.idFilial}'/>"/>
                	...
                	<table class="tabelaComponente">
                    	<tbody>
                        	...
                        	<tr>
 	                        	...
 	                        	<td class="componente"> 	                        		
                                	<input id="idFuncionarioF" name="idFuncionarioF" value="<c:out value='${idFuncionarioF}'/>" class="campo2" maxlength="11" style="width: 100px;" value="" type="text"/>
                                </td>
 	                        	<td class="componente">
 	                        		<label class="label" for="filialDesc">Nome:</label>
 	                        	</td>
 	                        	<td class="componente"  colspan="3"> 	                        		
                                	<input id="nomeFuncionarioF" name="nomeFuncionarioF" value="<c:out value='${nomeFuncionarioF}'/>" class="campo2" maxlength="60" style="width: 300px;" value="" type="text"/>
                                </td>
                            </tr>
                        </tbody>
                    </table>
				...
				<display:table pagesize='10' id="salariosBase" name="salariosBase" class="table" requestURI="">     
					<display:setProperty name="paging.banner.placement" value="bottom" />   
					<display:column title="" style="width:5%; text-align:center; "><input type="radio" name="checkbox" id="checkbox" value="${salariosBase.idEmpresa};${salariosBase.idFilial};${salariosBase.idFuncionario};${salariosBase.ano};${salariosBase.mes}"></display:column>
					<display:column property="periodoFormatado" title="Período" style="cursor: pointer; vertical-align: middle; width:15%; "/> 
					<display:column property="funcionarioFormatado" title="Funcionário" style="cursor: pointer; vertical-align: middle; width:30%; "/> 
					<display:column property="salarioBaseFormatado"  title="Salário Base" style="width:10%; text-align:right; cursor: pointer; vertical-align: middle;"/>
					<display:column property="idFilial"              title="Filial"       style="width:5%;        text-align:right; cursor: pointer; vertical-align: middle;"/>
				</display:table>
				<BR>
			</form>
		</div>
