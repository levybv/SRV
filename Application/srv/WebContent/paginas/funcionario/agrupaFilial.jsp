...
<script type="text/javascript" src="js/ms/srv.agrupaFilial.js" charset="ISO-8859-1"></script>
...
<div id="box" class="box">
	<div class="boxCenter">
		<div class="barTitleInternoCadastro">Agrupamento de Filiais por Funcionário</div>
		<br/>
		<div class="panel">
			<form id="form" name="form" method="post" action="" accept-charset="ISO-8859-1">
				...
				<br>
				<div class="barTitle">
					Agrupamento de Filiais por Funcionário
				...
				<display:table pagesize='10' id="agrupamentos" name="agrupamentos" class="table" requestURI="">     
					<display:setProperty name="paging.banner.placement" value="bottom" />   
					<display:column title="" style="width:5%; text-align:center; "><input type="radio" name="checkbox" id="checkbox" value="${agrupamentos.idEmpresa};${agrupamentos.idFilial};${agrupamentos.idFuncionario};${agrupamentos.ano};${agrupamentos.mes}"></display:column>
