...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#detMeta").validate({
	    	rules: {
	    			idFuncionarioF:   		{required:true, funcionarioExistex:true},
	     	...
	     	messages: {
			     	idFuncionarioF:   		{required:	   '<span class="erro-ini"><img src="images/ico_error.gif" class="imagem" /> Campo obrigat&oacute;rio.</span>',
		     				       funcionarioExistex:     '<span class="erro-ini"><img src="images/ico_error.gif" class="imagem" /> Funcionário já existe.</span>'},
	         ...
	         submitHandler : function(form){
		        $("#div-botao").hide();  
	           	$("#div-load").show(); 
		       	document.detMeta.action = "funcionario.do?operacao=incluiFuncionario";   
		...
		<table class="tabelaComponente">
			<tbody> 
				<tr>
					...
					<td class="componente" >
  						<input type="text" class="campo2" id="idFuncionarioF" name="idFuncionarioF" value="" maxlength="11" size="10"  />
					</td>
				</tr>			
				<tr>
					<td class="componente" >
				...
				<tr>
					<td class="componente" >
						<label class="label">Data de promoção ao Elegivel:</label> 
					</td>
					<td class="componente" >
