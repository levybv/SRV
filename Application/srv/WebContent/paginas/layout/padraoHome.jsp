	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			<c:if test="${mensagemErro != null}">
				mensagem('<img src="images/error.png" /> <span class="erro"><c:out value="${mensagemErro}"/></span>', true);
...
<div id="critical-msg" onclick="fecharMensagem();">
	...
	<span class="close-msg">Clique na mensagem para fechar.</span>
</div>
