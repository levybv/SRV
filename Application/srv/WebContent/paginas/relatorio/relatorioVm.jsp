...
<script type="text/javascript" src="js/ms/srv.relatorioVm.js" charset="ISO-8859-1"></script>

<div id="box" class="box">
	<div class="boxCenter">
		<div class="barTitleInternoCadastro">Relat&oacute;rio VM</div>
		<br/>
		<div class="panel">
                        	...
                        	<tr>
 	                        	...
 	                        	<td class="componente" width="40%">
                                	<select id="codigoRelatorio" name="codigoRelatorio" class="campo">
                                    	<option value="" selected>SELECIONE...</option>
										<c:forEach var="itemRelatorioVM" items="${listaRelatorioVM}">
											<option value="<c:out value='${itemRelatorioVM.codigo}'/>" ><c:out value='${itemRelatorioVM.codigo}' /> - <c:out value='${itemRelatorioVM.nome}' /></option>
										</c:forEach>
                                    </select>
                                </td>
