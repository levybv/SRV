...
<script type="text/javascript" src="js/ms/srv.relatorioLoja.js" charset="ISO-8859-1"></script>

<div id="box" class="box">
	<div class="boxCenter">
		<div class="barTitleInternoCadastro">Relat&oacute;rio Loja</div>
		<br/>
		<div class="panel">
                        	...
                        	<tr>
 	                        	...
 	                        	<td class="componente" width="40%">
                                	<select id="codigoRelatorio" name="codigoRelatorio" class="campo">
                                    	<option value="" selected>SELECIONE...</option>
										<c:forEach var="itemRelatorioLoja" items="${listaRelatorioLoja}">
											<option value="<c:out value='${itemRelatorioLoja.codigo}'/>" ><c:out value='${itemRelatorioLoja.codigo}' /> - <c:out value='${itemRelatorioLoja.nome}' /></option>
										</c:forEach>
                                    </select>
                                </td>
