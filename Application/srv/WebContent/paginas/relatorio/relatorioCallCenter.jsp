...
<script type="text/javascript" src="js/ms/srv.relatorioCallCenter.js" charset="ISO-8859-1"></script>

<div id="box" class="box">
	<div class="boxCenter">
		<div class="barTitleInternoCadastro">Relat&oacute;rio Call Center</div>
		<br/>
		<div class="panel">
                        	...
                        	<tr>
 	                        	...
 	                        	<td class="componente" width="40%">
                                	<select id="codigoRelatorio" name="codigoRelatorio" class="campo">
                                    	<option value="" selected>SELECIONE...</option>
										<c:forEach var="itemRelatorioCallCenterOutros" items="${listaRelatorioCallCenterOutros}">
											<option value="<c:out value='${itemRelatorioCallCenterOutros.codigo}'/>" ><c:out value='${itemRelatorioCallCenterOutros.codigo}' /> - <c:out value='${itemRelatorioCallCenterOutros.nome}' /></option>
										</c:forEach>
                                    </select>
                                </td>
