...
<script type="text/javascript" src="js/ms/srv.relatorioBonusPagamento.js" charset="ISO-8859-1"></script>

<div id="box" class="box">
	<div class="boxCenter">
		<div class="barTitleInternoCadastro">Relat&oacute;rio Bonus por Pagamento</div>
		<br/>
		<div class="panel">
