...
<script type="text/javascript" src="js/ms/srv.relatorioBonusDesempenhoColaborador.js" charset="ISO-8859-1"></script>

<div id="box" class="box">
	<div class="boxCenter">
		<div class="barTitleInternoCadastro">Relat&oacute;rio Desempenho por Colaborador</div>
		<br/>
		<div class="panel">
			...
			<input type='hidden' id="statusS" name="statusS" value="<c:out value='${status}'/>"/>
				...
				<display:table pagesize='10' id="listaRelatorioBonus" name="listaRelatorioBonus" class="table" requestURI="">
					...
					<display:column property="nomeFunc"          		title="Funcionario"             style="width:3%;  text-align:center; cursor: pointer; vertical-align: middle;"/>
					<display:column property="formula" 					title="formula"       			style="width:3%;  	text-align:center; cursor: pointer; vertical-align: middle;"/>
					<display:column property="indicador"   				title="indicador" 	      		style="width:10%;  	text-align:center; cursor: pointer; vertical-align: middle;"/>
					<display:column property="peso"       				title="peso"             		style="width:3%; 	text-align:center; cursor: pointer; vertical-align: middle;"/>
					<display:column property="meta"      				title="meta" 					style="width:6%; 	text-align:center; cursor: pointer; vertical-align: middle;"/>
					<display:column property="relaizado"     			title="relaizado"        		style="width:5%; 	text-align:center; cursor: pointer; vertical-align: middle;"/>
					<display:column property="atingimentoMeta"   		title="atingimento Meta"     	style="width:7%; 	text-align:center; cursor: pointer; vertical-align: middle;"/>
					<display:column property="escala" 					title="escala"           		style="width:3%;  	text-align:center; cursor: pointer; vertical-align: middle;"/>
					<display:column property="atingimentoEscala"  		title="atingimento Escala"   	style="width:5%;  	text-align:center; cursor: pointer; vertical-align: middle;"/>
					<display:column property="pesoResultado"        	title="peso Resultado"       	style="width:5%;  	text-align:center; cursor: pointer; vertical-align: middle;"/>
					<display:column property="ordem"        			title="Ordem"       			style="width:5%;  	text-align:center; cursor: pointer; vertical-align: middle;"/>
				</display:table>
