...
<script type='text/javascript' src='srvdwr/interface/RelatorioCallCenterBusinessAjax.js'></script>
<script type='text/javascript' src='srvdwr/engine.js'></script>	

<script type="text/javascript" src="js/ms/srv.relatorioCallCenterRealizado.js" charset="ISO-8859-1"></script>

<div id="box" class="box">
	<div class="boxCenter">
		<div class="barTitleInternoCadastro">Relat&oacute;rio Call Center - Realizado</div>
		<br/>
		<div class="panel">
