		...
		$("#detMeta").validate({
	        ...
	        submitHandler : function(form){
				...
				$(document).unbind('keydown', 'esc');
		       	...
		       	document.detMeta.action = "servlet/uploadPecaTicketServlet";
...
<div id="corpoModalAlterarConfigFilial" style="float:left;margin-left: 10px; width: 550px;">
	<form name="detMeta" id="detMeta" method="post" enctype="multipart/form-data"> 
				...
				<tbody> 
					<tr>
						<td class="componente" width="100%">
							<label class="label">Arquivo Realizado Loja (PPT):</label> 
						</td>
					</tr>				
					<tr>
						<td class="componente" >
			...
			<b>Coluna 4:</b> Valor realizado (Casas decimais delimitadas por v&iacute;rgula)<br/>
			<br/>
			<span class="requerido"><b>Exemplo:</b></span> 05;2010;10;1580,02<br/>
			<br/>
