	...
	$(document).ready(function() {
		...
		UnidadeBusinessAjax.obtemUnidades(
			function (unidades) {
				...
				$("#sequencialES").val(sequencial);
				$("#sequencial").val(sequencial);
				$("#idUnidadeFaixaES").val(idUnidadeFaixa);
				$("#faixaInicialES").val(faixaInicialFormatada.replace(' PT','').replace('%','').replace(' UN','').replace('R$ ',''));
				$("#faixaFinalES").val(faixaFinalFormatada.replace(' PT','').replace('%','').replace(' UN','').replace('R$ ',''));
				$("#idUnidadeRealizadoES").val(idUnidadeRealizado);
				$("#realizadoES").val(realizadoFormatado.replace(' PT','').replace('%','').replace(' UN','').replace('R$ ',''));
		});
		...
		$("#detMeta").validate({
	         ...
	         submitHandler : function(form){
			        $("#div-botao").hide();  
		           	$("#div-load").show(); 
			       	document.detMeta.action = "faixaEscala.do?operacao=alteraFaixaEscala";   
