 ...
 *
 */
public class RelatorioVmAction extends BasicAction {

	private static final String FORWARD_RELATORIO_VM = "relatorio";
	...
	public ActionForward inicio(ActionMapping pMapping, ActionForm pForm, HttpServletRequest pRequest, HttpServletResponse pResponse) throws SRVException {
		...
		relatorioTipoVO.setCodigo(Constantes.RELATORIO_TIPO_VM);
		pesquisaVO.setRelatorioTipoVO(relatorioTipoVO);
		pesquisaVO.setIsAtivo(true);
		pRequest.setAttribute("listaRelatorioVM", RelatorioBusiness.getInstance().obtemRelatorio(pesquisaVO));
		return pMapping.findForward(FORWARD_RELATORIO_VM);
	}
	 ...
	 * @throws SRVException
	 */
	public ActionForward geraRelatorioVM(ActionMapping pMapping, ActionForm pForm, HttpServletRequest pRequest, HttpServletResponse pResponse) throws SRVException {
		...
		try {
			...
			throw new SRVException("Erro ao gerar o relatorio VM", ex);
		}
