 ...
 *
 */
public class RelatorioSaxAction extends BasicAction {

	private static final String FORWARD_RELATORIO_SAX = "relatorio";
	...
	public ActionForward inicio(ActionMapping pMapping, ActionForm pForm, HttpServletRequest pRequest, HttpServletResponse pResponse) throws Exception {
		...
		relatorioTipoVO.setCodigo(Constantes.RELATORIO_TIPO_SAX);
		pesquisaVO.setRelatorioTipoVO(relatorioTipoVO);
		pesquisaVO.setIsAtivo(true);
		pRequest.setAttribute("listaRelatorioSax", RelatorioBusiness.getInstance().obtemRelatorio(pesquisaVO));
		return pMapping.findForward(FORWARD_RELATORIO_SAX);
	}
	 ...
	 * @throws SRVException
	 */
	public ActionForward geraRelatorioSax(ActionMapping pMapping, ActionForm pForm, HttpServletRequest pRequest, HttpServletResponse pResponse) throws SRVException {
		...
		try {
			...
			throw new SRVException("Erro ao gerar o relatorio SAX", ex);
		}
