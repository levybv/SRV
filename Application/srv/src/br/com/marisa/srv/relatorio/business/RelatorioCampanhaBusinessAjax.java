 ...
 *
 */
public class RelatorioCampanhaBusinessAjax {
	...
	public List<CampanhaVO> obtemListaCampanha() throws Exception {
		return RelatorioCampanhaBusiness.getInstance().obtemListaCampanha(null);
	}
}